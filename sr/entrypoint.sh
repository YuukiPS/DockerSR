...
SHORT=db:,webip:,webport:,weburlssl:,gameip:,gameport:,msgwc,mailmsg:,dlres:,lang:,loginpass:,po:,nmsv:,nmow:,nmrg:,ssl:,h
LONG=datebase:,web_ip:,web_port:,web_url_ssl:,game_ip:,game_port:,message_welcome:,mail_message:,download_resource:,language:,login_password:,player_online:,name_server:,name_owner:,name_region:,ssl:,help
...
if [ ! -f "config.json" ]; then
 ...
 #json -q -I -f config.json -e "this.HTTP.HTTP_PORT='$set_web_port'"
